...
public interface DailyHistoricalWeatherDataApi
{
	...
	public HistoryDay historyDailycityIdcityIdGet(@PathParam("city_id") String cityId, @QueryParam("start_date") String startDate,
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "An Historical Day Data Object.", response = HistoryDay.class),
		@ApiResponse(code = 0, message = "No Data.", response = Error.class) })
	public HistoryDay historyDailycitycitycountrycountryGet(@PathParam("city") String city, @PathParam("country") String country,
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "An Historical Day Data Object.", response = HistoryDay.class),
		@ApiResponse(code = 0, message = "No Data.", response = Error.class) })
	public HistoryDay historyDailyipipGet(@PathParam("ip") String ip, @QueryParam("start_date") String startDate,
		@QueryParam("end_date") String endDate, @QueryParam("key") String key, @QueryParam("units") String units,
		@QueryParam("lang") String lang, @QueryParam("callback") String paramCallback);
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "An Historical Day Data Object.", response = HistoryDay.class),
		@ApiResponse(code = 0, message = "No Data.", response = Error.class) })
	public HistoryDay historyDailylatlatlonlonGet(@PathParam("lat") Double lat, @PathParam("lon") Double lon,
		@QueryParam("start_date") String startDate, @QueryParam("end_date") String endDate, @QueryParam("key") String key,
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "An Historical Day Data Object.", response = HistoryDay.class),
		@ApiResponse(code = 0, message = "No Data.", response = Error.class) })
	public HistoryDay historyDailypostalCodepostalCodeGet(@PathParam("postal_code") String postalCode,
		@QueryParam("start_date") String startDate, @QueryParam("end_date") String endDate, @QueryParam("key") String key,
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "An Historical Day Data Object.", response = HistoryDay.class),
		@ApiResponse(code = 0, message = "No Data.", response = Error.class) })
	public HistoryDay historyDailystationstationGet(@PathParam("station") String station,
		@QueryParam("start_date") String startDate, @QueryParam("end_date") String endDate, @QueryParam("key") String key,
		@QueryParam("units") String units, @QueryParam("lang") String lang, @QueryParam("callback") String paramCallback);
}
